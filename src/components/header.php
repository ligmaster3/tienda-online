        ...
        <div class="container-fluid mb-2">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul
                    ...
                    <li><a href="/src/public/carrito.php" class="nav-link px-2  linear">Carrito</a></li>
                ...
                <form class="d-flex text-end">
                    <div class="text-end">
                        <button class="btn btn-outline-dark position-relative text-white mx-3" type="submit">
                            ...
                            <a href="src/public/carrito.php" class="text-decoration-none">Cart</a>
                            <span
                                class="badge bg-dark text-white ms-1 rounded-pill position-absolute top-50 start-100 translate-middle"
                                id="num_cont"><?php echo $totalProductosCarrito; ?></span>
                        </button>
                    </div>
                </form>
            </div>
